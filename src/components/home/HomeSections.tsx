...
const offers = [
  ...
  { eyebrow: 'Se former individuellement', title: 'Parcours formateur indépendant', copy: "Suivez la formation complète en e-learning, accédez aux trois ateliers du Studio pendant 1 an et participez aux office hours deux fois par mois.", bullets: ['Formation complète en e-learning', "Studio pendant 1 an, avec 60 minutes d'audio par mois pendant 6 mois", 'Communauté pendant 1 an et office hours deux fois par mois'], note: 'Cohorte de septembre : 490 € HT en tarif fondateur (590 € ensuite). La formation peut être suivie en français ou en anglais.', cta: "Rejoindre la liste d'attente", href: '/offre' },
  { eyebrow: 'Former une équipe', title: 'Programme institut', copy: 'Installez une méthode commune dans votre équipe avec 6 webinaires dédiés, du coaching sur vos cas réels et un espace privé dans la communauté.', bullets: ['À partir de 4 200 € HT', 'De 1 à 15 formateurs (au-delà, formule étendue)', 'Studio et communauté pendant 12 mois', 'Certifié Qualiopi : financement OPCO'], note: 'La formation peut être animée en français ou en anglais.', cta: 'Réserver un appel découverte', href: 'https://scheduler.zoom.us/greg-le-dall/decouverte' },
];
